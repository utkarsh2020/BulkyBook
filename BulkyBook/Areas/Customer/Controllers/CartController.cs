...
namespace BulkyBook.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public async Task<IActionResult> IndexPOST()
        {
            ...
            if (user == null)
            {
                ModelState.AddModelError(string.Empty, "Verfication email id empty");
            }
        ...
        public IActionResult SummaryPOST(string stripeToken)
        {
            ...
            {
                item.Price = SD.GetPriceBasedOnQuantity(item.Count, item.Product.Price, item.Product.Price50, item.Product.Price100) * item.Count;
